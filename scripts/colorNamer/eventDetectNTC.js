$(document).ready(function () {
  ...
  // ntc.names = ntc.names.slice(1, 100);
  // ntc.names.sort(nameComparator);
  sortedRGB = ntc.names.sort(nameComparator);

  console.log(sortedRGB);

  for (var i = 0; i < sortedRGB.length; i++) {
    toRGB.push(sortedRGB[i][2] + sortedRGB[i][3] + sortedRGB[i][4])
  }
  // console.log(toRGB);
