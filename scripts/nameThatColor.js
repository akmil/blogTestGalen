...
var ntc = {
  ...
  init: function() {
    ...
    ntc.names = ntc.mixArray(globalJson.colorsList, ntc.names);    
  ...
  mixArray: function(additionalArr,originArr){
    var arr = originArr;
    additionalArr.forEach(function(i){
      var isAdd = 1;
      arr.forEach(function(j){
        var newColor = i.color.replace('#',''), oldColor = j[0];
        if(newColor === oldColor) isAdd = 0;
      });
      if(isAdd) arr.push([i.color.replace('#','') , i.name])
    });
    return arr
  },
